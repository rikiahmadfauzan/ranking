...
<body id="page-top">
    <div id="wrapper">
        <ul class="navbar-nav bg-primary sidebar fw-bold sidebar-dark accordion" id="accordionSidebar">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex align-items-center">
                        <h4 class="text-gray-800">Sektor LBG 1</h4>
                    </div>
                    <h6 class="text-gray-800 mb-3">Ali Sidik</h6>
                                    ...
                                    <div class="modal fade" id="editModal{{ $item->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form action="/layout1/update1/{{ $item->id }}" method="post" enctype="multipart/form-data">
                                                    @csrf
                                                    <p class="mb-1">Kode Teknisi</p>
                                                    <input class="form-control" type="text" name="kd_teknisi" id="" value="{{ $item->kd_teknisi }}" readonly>
                                                    <p class="mb-1">Nama</p>
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            ...
            <div class="modal-body">
                ...
                <form action="/layout1/create1" method="post" enctype="multipart/form-data">
                    @csrf
                    <p class="mb-1">Kode Teknisi</p>
                    <input class="form-control" type="text" name="kd_teknisi" id="">
                    <p class="mb-1">Nama</p>
