            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex align-items-center">
                        <h4 class="text-gray-800">Sektor LBG 3</h4>
                    </div>
                    <h6 class="text-gray-800 mb-3">Agung Kurniawan</h6>
                    <button type="button" style="width: 140px;left: 100px" class="btn btn-primary mt-1 mb-3" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                    ...
                                    <div class="modal fade" id="editModal{{ $item->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form action="/layout3/update3/{{ $item->id }}" method="post" enctype="multipart/form-data">
                                                    @csrf
                                                    <p class="mb-1">Nama</p>
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            ...
            <div class="modal-body">
                ...
                <form action="/layout3/create3" method="post">
                    @csrf
